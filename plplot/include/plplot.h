/* $Id: plplot.h,v 1.166 2005/05/03 14:47:55 airwin Exp $
...
/* Draws a line segment connecting two points. Modified by Gang-Gyoo Jin, KMU*/
void plline1(PLINT n, PLFLT x, PLFLT y, PLINT *s, PLINT icolor);
