...
static int plhlsrgbCmd( ClientData, Tcl_Interp *, int, char **);
...
static int plrgbhlsCmd( ClientData, Tcl_Interp *, int, char **);
...
static int plsvectCmd( ClientData, Tcl_Interp *, int, char **);
